    ...
    <div className="space-y-1.5 w-full">
      ...
      <div className="relative">
        <select
          id={id}
          disabled={disabled}
          className={`w-full px-4 py-2.5 rounded-lg bg-zinc-50 border text-sm text-zinc-900 dark:bg-slate-950 dark:text-slate-100 outline-none appearance-none transition-all duration-200 focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed pr-10 ${
